...
{
    this->usuario.setEmailUsuario(ui->emailLogin->text().toStdString());
    this->usuario.setPwordUsuario(ui->senhaLogin->text().toStdString());
...
{
    QSqlDatabase query = QSqlDatabase::database();
    query.open();
    query.transaction();
    query.exec("DROP TABLE IF EXISTS astros.Equip_avist");
    query.exec("DROP TABLE IF EXISTS astros.Avist_astro");
    query.exec("DROP TABLE IF EXISTS astros.Astro");
    query.exec("DROP TABLE IF EXISTS astros.Sistema_solar");
    query.exec("DROP TABLE IF EXISTS astros.Imagem");
    query.exec("DROP TABLE IF EXISTS astros.Avistamento");
    query.exec("DROP TABLE IF EXISTS astros.Local");
    query.exec("DROP TABLE IF EXISTS astros.Publicacao");
    query.exec("DROP TABLE IF EXISTS astros.Equipamento");
    query.exec("DROP TABLE IF EXISTS astros.Tipo_equipamento");
    query.exec("DROP TABLE IF EXISTS astros.Usuario");
    query.exec("DROP SCHEMA IF EXISTS astros");

    QMessageBox message(ui->centralwidget);
    message.addButton(QMessageBox::Ok);
    if(query.commit())
        message.setText("Tabelas excluidas");
    else
        message.setText("Algo deu errado ao deletar as tabelas");
...
void Login::on_pushButton_2_clicked()
{
    ...
    //query.open();
    //query.transaction();
    query.exec("CREATE SCHEMA astros AUTHORIZATION postgres");
    query.exec("CREATE TABLE astros.Usuario ("
    ...
    query.exec("CREATE TABLE astros.Publicacao ("
               " id_publi serial PRIMARY KEY,"
               " desc_publi varchar(1000),"
               " data_publi timestamp,"
               " is_public boolean)");

    query.exec("CREATE TABLE astros.Astro ("
    ...
    query.exec("CREATE TABLE astros.Imagem ( "
               " id_imagem serial PRIMARY KEY,"
               " desc_imagem varchar(100),"
               " tamanho_imagem numeric,"
               " id_avistamento integer)");

    query.exec("CREATE TABLE astros.Avistamento ("
    ...
    query.exec("CREATE TABLE astros.Local ("
    ...
    query.exec("CREATE TABLE astros.Equipamento ("
    ...
    query.exec("CREATE TABLE astros.Tipo_Equipamento ("
               " id_tipo_equip serial PRIMARY KEY,"
               " desc_tipo_equip varchar(50))");

    query.exec("CREATE TABLE astros.Sistema_Solar ("
               " id_sissolar serial PRIMARY KEY,"
               " nome_sissolar varchar(50))");

    query.exec("CREATE TABLE astros.Avist_astro ("
               " id_astro integer,"
               " id_avistamento integer)");

    query.exec("CREATE TABLE astros.Equip_avist ("
              " id_equip integer,"
              " id_avistamento integer)");

    query.exec("ALTER TABLE astros.Astro ADD CONSTRAINT FK_Astro_2"
                " FOREIGN KEY (id_sissolar)"
                " REFERENCES astros.Sistema_Solar (id_sissolar)"
                " ON DELETE SET NULL");

    query.exec("ALTER TABLE astros.Imagem ADD CONSTRAINT FK_Imagem_2"
                " FOREIGN KEY (id_avistamento)"
                " REFERENCES astros.Avistamento (id_avistamento)"
                " ON DELETE CASCADE");

    query.exec("ALTER TABLE astros.Avistamento ADD CONSTRAINT FK_Avistamento_2"
                " FOREIGN KEY (id_usuario)"
                " REFERENCES astros.Usuario (id_usuario)"
                " ON DELETE CASCADE");

    query.exec("ALTER TABLE astros.Avistamento ADD CONSTRAINT FK_Avistamento_3"
                " FOREIGN KEY (id_local)"
                " REFERENCES astros.Local (id_local)"
                " ON DELETE CASCADE");

    query.exec("ALTER TABLE astros.Avistamento ADD CONSTRAINT FK_Avistamento_4"
                " FOREIGN KEY (id_publi)"
                " REFERENCES astros.Publicacao (id_publi)"
                " ON DELETE SET NULL");

    query.exec("ALTER TABLE astros.Equipamento ADD CONSTRAINT FK_Equipamento_2"
                " FOREIGN KEY (id_tipo_equip)"
                " REFERENCES astros.Tipo_Equipamento (id_tipo_equip)"
                " ON DELETE CASCADE");

    query.exec("ALTER TABLE astros.Avist_astro ADD CONSTRAINT FK_Avist_astro_1"
                " FOREIGN KEY (id_astro)"
                " REFERENCES astros.Astro (id_astro)"
                " ON DELETE RESTRICT");

    query.exec("ALTER TABLE astros.Avist_astro ADD CONSTRAINT FK_Avist_astro_2"
                " FOREIGN KEY (id_avistamento)"
                " REFERENCES astros.Avistamento (id_avistamento)"
                " ON DELETE SET NULL");

    query.exec("ALTER TABLE astros.Equip_avist ADD CONSTRAINT FK_Equip_avist_1"
                " FOREIGN KEY (id_equip)"
                " REFERENCES astros.Equipamento (id_equip)"
                " ON DELETE RESTRICT");

    query.exec("ALTER TABLE astros.Equip_avist ADD CONSTRAINT FK_Equip_avist_2"
               " FOREIGN KEY (id_avistamento)"
               " REFERENCES astros.Avistamento (id_avistamento)"
               " ON DELETE SET NULL");

    query.exec("INSERT INTO astros.Tipo_equipamento (desc_tipo_equip) VALUES ('Binóculos');"
    ...
    query.exec("INSERT INTO astros.Usuario (nome_usuario, email_usuario, bio_usuario, data_nasc_usu, pword_usuario)"
    ...
    query.exec("INSERT INTO astros.Local (cidade, estado_prov, pais, latitude, longitude)"
    ...
    query.exec("INSERT INTO astros.Equipamento (nome_equip, marca_equip, espec_equip, id_tipo_equip)"
    ...
    query.exec("INSERT INTO astros.Sistema_solar (nome_sissolar) VALUES('Sistema Sol');");

    query.exec("INSERT INTO astros.Astro (nome_astro, dec_astro, ra_astro, distance_astro,"
    ...
    query.exec("INSERT INTO astros.Publicacao (desc_publi, data_publi, is_public)"
    ...
    query.exec("INSERT INTO astros.Avistamento (id_usuario, id_local, id_publi, data_avist) VALUES (1, 1, 1, '2023-05-01 01:23');"
    ...
    query.exec("INSERT INTO astros.Equip_avist (id_equip, id_avistamento) VALUES (8, 1);"
    ...
    query.exec("INSERT INTO astros.Avist_astro (id_astro, id_avistamento) VALUES (1, 1);"
    ...
    query.exec("INSERT INTO astros.Imagem (desc_imagem, tamanho_imagem, id_avistamento)"
    ...
    message.addButton(QMessageBox::Ok);
    if(query.isActive())
        message.setText("Tabelas criadas e preenchidas");
    else{
        message.setText("Algo deu errado ao criar e preencher as tabelas");
